...
namespace RazorHtmlEmails.Common
{
    public class RegisterAccountService : IRegisterAccountService
    {
        ...
        public async Task<string> GetEmailHTMLBody()
        {
            string body = await _razorViewToStringRenderer.RenderViewToStringAsync("~/Views/Emails/RebookSessions/RebookSessionsEmail.cshtml", "");
            //C:\Dropbox\C# lessons 2018\ASPNZBat Working\RazorHtmlEmails.RazorClassLib\Views\Emails\RebookSessions\RebookSessionsEmail.cshtml
            return body;
        }
